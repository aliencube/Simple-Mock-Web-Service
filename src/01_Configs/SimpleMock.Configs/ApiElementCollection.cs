...
namespace Aliencube.SimpleMock.Configs
{
    ...
    public class ApiElementCollection : ConfigurationElementCollection
    {
        ...
        {
            get { return (ApiElement)this.BaseGet(index); }
            set
            {
        ...
        public new ApiElement this[string key]
        {
            get { return (ApiElement)this.BaseGet(key); }
            set
            {
                var item = (ApiElement)this.BaseGet(key);
                if (item != null)
                {
        ...
        public void Add(ApiElement element)
        {
