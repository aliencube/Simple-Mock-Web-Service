...
namespace Aliencube.SimpleMock.Services.Interfaces
{
    /// <summary>
    ...
    public interface IMockService : IDisposable
    {
        ...
        Task<string> GetApiResponseAsync(string src);
        ...
        Task<HttpResponseMessage> GetHttpResponseAsync(HttpRequestMessage request, string value = null);
    }
}